...
def manually_fill(): 
    ...
    def fill_attendance(): 
        ...
        try: 
            global cursor 
            connection = sqlite3.connect('manually_fill_attendance.db')  # Use SQLite
        ...
        if subb == '': 
            ...
            def enter_data_DB(): 
                ...
                if ENROLLMENT == '': 
                    ...
                    Insert_data = "INSERT INTO " + DB_table_name + \
                        " (ENROLLMENT, NAME, DATE, TIME) VALUES (?, ?, ?, ?)" 
            ...
            def create_csv(): 
                ...
                csv_name = 'C:\\Users\\manid\\OneDrive\\Desktop\\Attendance_Management_System\\Attendance\\Manually Attendance' + DB_table_name + '.csv' 
            ...
            clear_enroll = tk.Button(MFW, text="Clear", command=remove_enr, fg="white", bg="black", width=10, 
                                     height=1, activebackground="white", font=('times', 15, ' bold ')) 
            clear_enroll.place(x=690, y=100) 

            clear_student = tk.Button(MFW, text="Clear", command=remove_student, fg="white", bg="black", width=10, 
                                      height=1, activebackground="white", font=('times', 15, ' bold ')) 
            ...
            def attf(): 
                import subprocess 
                subprocess.Popen(r'explorer /select,"C:\Users\manid\OneDrive\Desktop\Attendance_Management_System\Attendance\Manually Attendance-------Check atttendance-------"') 
...
def subjectchoose(): 
    def Fillattendances(): 
        ...
        if time.time() < future: 
            if sub == '': 
                ...
                df.columns = ['Enrollment','Name','Date','Time']
                print(df.columns) 
                ...
                try: 
                    global cursor 
                    connection = sqlite3.connect('Face_reco_fill.db')  # Use SQLite 
                    cursor = connection.cursor() 
                except Exception as e: 
                    print(e) 
                ...
                insert_data = "INSERT INTO " + DB_Table_name + " (ENROLLMENT, NAME, DATE, TIME) VALUES (?, ?, ?, ?)" 
                ...
                root.configure(background='grey80') 
                cs = 'C:\\Users\\manid\\OneDrive\\Desktop\\Attendance_Management_System' + fileName 
    ...
    def Attf(): 
        import subprocess 
        subprocess.Popen(r'explorer /select,"C:\Users\manid\OneDrive\Desktop\Attendance_Management_System\Attendance-------Check atttendance-------"') 
    ...
    def log_in(): 
        ...
        if username == 'pragya': 
            if password == 'pragya123': 
                ...
                cs = 'C:\\Users\\manid\\OneDrive\\Desktop\\Attendance_Management_System\\StudentDetails\\StudentDetails.csv' 
                with open(cs, newline="") as file: 
                    reader = csv.reader(file) 
                    r = 0 
